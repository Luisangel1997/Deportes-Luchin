function validar() {
    ...
    var radio1 = document.getElementById("Radios1");
    var radio2 = document.getElementById("Radios2");
    var radio3 = document.getElementById("Radios3");
    ...
    if (radio1.checked === false && radio2.checked === false && radio3.checked === false) {
        document.getElementById('lSexo').innerHTML = "porfavor, marque una de las casillas de sexo";
        document.getElementById('lSexo').style.color = 'red';
        return
    } else {
        document.getElementById('lSexo').innerHTML = "ok!";
        document.getElementById('lSexo').style.color = 'green';
    }
